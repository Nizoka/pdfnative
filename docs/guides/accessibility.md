...
veraPDF is the reference PDF/A validator. The pdfnative test suite generates ~219 sample PDFs and the PDF/A samples are validated against veraPDF on every release.
