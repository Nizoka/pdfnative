...
|---|---|---|
| `ENCRYPTED_SOURCE` | `merge_pdfs`, `split_pdf`, `extract_pages`, `annotate_pdf` | The source PDF is encrypted. Decrypt it outside the server first. |
| `OUTPUT_TOO_LARGE` | `split_pdf` | A part or the aggregate exceeds the size cap (50 MiB/part, 200 MiB aggregate). |
