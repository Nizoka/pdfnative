...
import { CURATED_SEQUENCES } from './lib/curated-emoji-sequences.js';
 ...
 */`,
    ...
    // it within the ~5 MB budget (the full ~3 600-glyph set is ~32 MB and is
    // intentionally left to the CLI). Trim the curated lists if this trips.
    // Raised 4096 → 5120 in v1.7.0 for the curated flag/ZWJ sequence set.
    ...
    if (stats.sizeKb > MAX_SIZE_KB) {
        throw new Error(
            ...
            'trim scripts/lib/curated-emoji.ts or curated-emoji-sequences.ts',
        );
    }
