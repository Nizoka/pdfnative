...
tests/            # 2388+ tests (105 files: unit/integration/fuzz/parser/visual) mirroring src/ structure
...
npm run test            # vitest run (2388+ tests, 105 files)
...
- All new code must have tests. Current: ~95% statement coverage, 2388+ tests (105 files)
...
- **95%+ test coverage** — 2388+ tests (105 files), 48 fuzz edge-cases (including recursion/zip-bomb/xref-chain hardening), dual-mode visual-regression suite, performance benchmarks
