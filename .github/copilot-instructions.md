...
tests/            # 2664+ tests (122 files: unit/integration/fuzz/parser/visual) mirroring src/ structure
...
- All new code must have tests. 95%+ statements measured at the v1.6.0 release; CI enforces 88/80/85/90. 2664+ tests (122 files)
