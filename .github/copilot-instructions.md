...
tests/            # 2360+ tests (104 files: unit/integration/fuzz/parser/visual) mirroring src/ structure
...
npm run test            # vitest run (2360+ tests, 104 files)
...
- **95%+ test coverage** — 2360+ tests (104 files), 48 fuzz edge-cases (including recursion/zip-bomb/xref-chain hardening), dual-mode visual-regression suite, performance benchmarks
