...
```bash
npm run test           # vitest run (2090+ tests)
...
scripts/          # Modular sample PDF generation (34 generators, 195+ PDFs)
tests/            # 2090+ tests (77 files: unit + integration + fuzz + parser), mirrors src/ structure
