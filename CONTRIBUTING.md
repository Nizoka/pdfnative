...
npm run verify:docs    # 22 offline rules over docs/, playgrounds, README, llms files
...
tests/            # 2687+ tests (123 files: unit + integration + fuzz + parser + docs), mirrors src/ structure
