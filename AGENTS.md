...
Quality bar: GAFAM-grade. 2365+ tests, 95%+ statement coverage, blocking veraPDF validation in CI, SLSA provenance on npm.
...
npm run lint               # eslint
npm run test:generate      # produce ~227 sample PDFs → test-output/
